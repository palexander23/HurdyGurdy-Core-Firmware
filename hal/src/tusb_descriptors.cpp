/**
 * @file    tusb_descriptors.cpp
 * @author  Peter Alexander (peter.d.alexander23@gmail.com)
 * @brief   Definitions and callbacks for USB Descriptors
...
// Define Endpoint numbers for the CDC interface
...
uint8_t const desc_hs_configuration[] = {
    // Configuration Descriptor, the same as the Full Speed version
    TUD_CONFIG_DESCRIPTOR(1, ITF_NUM_TOTAL, 0, CONFIG_TOTAL_LEN, 0x00, 100),
...
// Call back to hand the device qualifier to TinyUSB
uint8_t const* tud_descriptor_device_qualifier_cb(void)
{
    return (uint8_t const*)&desc_device_qualifier;
}

// Define a space for the "other" speed configuration
uint8_t desc_other_speed_config[CONFIG_TOTAL_LEN];

// Call back to hand the descriptor for the "other" speed to TinyUSB
// This is the descriptor that we aren't using.
